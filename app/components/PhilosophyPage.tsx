...
export default function PhilosophyPage() {
    ...
    const philosophyPillars = [
        {
            ...
            description:
                "Every decision, every creative output, every strategic move begins with logic. We don't guess. We don't hope. We calculate, analyze, and then act.",
            principles: [
        ...
        },
        {
            ...
            description:
                "Organizations don't need more tasks completed. They need systems that work independently, scale intelligently, and govern consistently.",
            principles: [
        ...
        },
        {
            ...
            description:
                "Trial-and-error is expensive, risky, and unprofessional. We engineer solutions based on proven frameworks, strategic intelligence, and calculated outcomes.",
            principles: [
        ...
        },
        {
            ...
            description:
                "AI doesn't replace human strategic thinking—it amplifies it. We use artificial intelligence to accelerate decisions, reduce effort, and protect margins.",
            principles: [
    ...
    const brandEtymology = {
        navi: {
            meaning: "Navigation",
            description:
                "Direction before motion. Strategic clarity before execution.",
            color: "text-white",
        },
        star: {
            ...
            <section className="relative min-h-[80vh] sm:min-h-screen flex items-center justify-center px-4 sm:px-6 py-20">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10 w-full">
                    <div className="inline-flex items-center gap-2 mb-6 sm:mb-8 px-4 sm:px-6 py-2 sm:py-3 bg-neon-orange/10 border border-neon-orange/30 rounded-full hover-lift">
                        ...
                        <span className="text-neon-orange text-xs sm:text-sm font-mono">
                            STRATEGIC_PHILOSOPHY_ACTIVE
                        </span>
                    </div>
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 sm:mb-8 leading-tight font-serif">
                        ...
                        <span className="block text-neon-orange">
                            agencies.
                        </span>
                    ...
                    <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto mb-8 sm:mb-12 font-serif px-4">
                        Most organizations don't fail due to lack of effort.
                        They fail due to lack of direction, coherence, and
                        intelligence. NaviStarq exists to solve that.
                    </p>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12 sm:mb-16">
                        ...
                        <p className="text-lg sm:text-xl text-gray-400 font-serif">
                            Every element of our identity reflects strategic
                            intention.
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                            {Object.entries(brandEtymology).map(
                                ([key, data], index) => (
                                    <div
                                        key={key}
                                        className="text-center p-4 sm:p-6 border border-gray-700 hover:border-neon-orange/50 transition-all duration-500 hover-lift group"
                                    >
                                        <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-gradient-to-br from-neon-orange/20 to-transparent rounded-full flex items-center justify-center group-hover:from-neon-orange/40 transition-all duration-500">
                                            <span
                                                className={`text-lg sm:text-2xl font-bold ${data.color} group-hover:scale-110 transition-transform duration-300`}
                                            >
                                                {key.toUpperCase()}
                                            </span>
                                        </div>
            ...
            <section className="py-16 sm:py-20 px-4 sm:px-6 border-t border-neon-orange/20">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12 sm:mb-16">
                        ...
                        <p className="text-lg sm:text-xl text-gray-400 font-serif">
                            Four foundational principles that govern every
                            engagement.
                        </p>
                    </div>
                    ...
                    <div className="space-y-12 sm:space-y-16">
                        {philosophyPillars.map((pillar, index) => (
                                        ...
                                        <div className="space-y-2">
                                            {pillar.principles.map(
                                                (principle, pIndex) => (
                                                    ...
                                                    >
                                                        <div
                                                            className="w-1 h-4 sm:h-6 mt-1"
                                                            style={{
                                                                backgroundColor:
                                                                    pillar.color,
                                                            }}
                                                        />
                                                        <span className="text-gray-300 font-serif text-sm sm:text-base">
                                                            {principle}
                                                        </span>
                                                    </div>
                                                ),
                                    ...
                                    {index === 0 && (
                                        ...
                                        <div className="relative h-48 sm:h-64 bg-gradient-to-br from-gray-900 via-black to-gray-800 border border-gray-700 overflow-hidden rounded-lg">
                                            <div className="absolute inset-0">
                                                ...
                                                <div
                                                    className="absolute top-12 right-12 w-2 h-2 bg-orange-400 rounded-full animate-pulse"
                                                    style={{
                                                        animationDelay: "0.5s",
                                                    }}
                                                />
                                                <div
                                                    className="absolute bottom-16 left-16 w-4 h-4 bg-yellow-500 rounded-full animate-pulse"
                                                    style={{
                                                        animationDelay: "1s",
                                                    }}
                                                />
                                                <div
                                                    className="absolute bottom-8 right-8 w-2 h-2 bg-red-400 rounded-full animate-pulse"
                                                    style={{
                                                        animationDelay: "1.5s",
                                                    }}
                                                />
                                            ...
                                            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                                                ...
                                                <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded">
                                                    <div
                                                        className="h-full bg-gradient-to-r from-neon-orange to-yellow-400 rounded transition-all duration-2000"
                                                        style={{ width: "92%" }}
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    {index === 1 && (
                                        ...
                                        <div className="relative h-48 sm:h-64 bg-gradient-to-br from-gray-900 via-black to-gray-800 border border-gray-700 overflow-hidden rounded-lg">
                                            ...
                                            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                                                ...
                                                <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded">
                                                    <div
                                                        className="h-full bg-gradient-to-r from-neon-orange to-orange-400 rounded transition-all duration-2000"
                                                        style={{ width: "88%" }}
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    {index === 2 && (
                                        ...
                                        <div className="relative h-48 sm:h-64 bg-gradient-to-br from-gray-900 via-black to-gray-800 border border-gray-700 overflow-hidden rounded-lg">
                                            ...
                                            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                                                ...
                                                <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded">
                                                    <div
                                                        className="h-full bg-gradient-to-r from-green-400 to-neon-orange rounded transition-all duration-2000"
                                                        style={{ width: "96%" }}
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="absolute inset-0 p-4">
                                                ...
                                                <div className="absolute top-1/2 right-8 transform -translate-y-1/2">
                                                    <div className="relative w-16 h-16">
                                                        <div
                                                            className="absolute inset-0 border-2 border-neon-orange/30 rounded-full animate-spin"
                                                            style={{
                                                                animationDuration:
                                                                    "3s",
                                                            }}
                          ...
                          AI_INTELLIGENCE_ACTIVE
                                                ...
                                                <div className="w-full h-1.5 sm:h-2 bg-gray-800 rounded">
                                                    <div
                                                        className="h-full bg-gradient-to-r from-blue-400 to-neon-orange rounded transition-all duration-2000"
                                                        style={{ width: "94%" }}
                                                    />
                                                </div>
                                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-base sm:text-lg text-gray-300 leading-relaxed font-serif">
                                        To be the definitive strategic partner
                                        for organizations that demand clarity,
                        ...
                        <div className="relative p-6 sm:p-8 bg-gradient-to-l from-gray-900 to-black border-r-4 border-neon-orange">
                            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-base sm:text-lg text-gray-300 leading-relaxed font-serif">
                                        We engineer systematic solutions that
                                        eliminate trial-and-error from business
                                        growth, reputation management, and
            ...
            <section className="py-16 sm:py-20 px-4 sm:px-6 border-t border-neon-orange/20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg sm:text-xl text-gray-400 mb-8 sm:mb-12 font-serif">
                        No trial-and-error. No guesswork. Just systematic
                        growth.
                    </p>
                    <button
                        onClick={() => {
