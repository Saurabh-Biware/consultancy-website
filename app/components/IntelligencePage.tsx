            ...
            if (ctx) {
                const animate = () => {
                    ...
                    for (let i = 0; i < nodes; i++) {
                        ...
                        ctx.globalAlpha =
                            0.6 + Math.sin(Date.now() * 0.003 + i) * 0.4;
                        ctx.beginPath();
                        ...
                        for (let j = i + 1; j < nodes; j++) {
                            ...
                            ctx.globalAlpha =
                                0.1 +
                                Math.sin(Date.now() * 0.002 + i + j) * 0.1;
                            ctx.lineWidth = 1;
                            ctx.beginPath();
                            ctx.moveTo(x, y);
                            ctx.lineTo(x2, y2);
    ...
    const capabilities = [
        {
            ...
            description:
                "Multi-layered decision trees that mirror C-suite thinking patterns",
            status: "ACTIVE",
            confidence: 97,
        },
        {
            ...
            description:
                "Market scenario modeling with probabilistic outcome analysis",
            status: "LEARNING",
            confidence: 94,
        },
        {
            ...
            description:
                "Cross-domain pattern recognition for strategic insight generation",
            status: "OPTIMIZING",
            confidence: 99,
        },
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                                Not automation. Not pattern matching. Artificial
                                intelligence that reasons through complexity
                                like seasoned executives.
                            </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-400">
                            Real-time AI processing across strategic domains
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6 mb-16">
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 p-6 rounded-xl">
                            <div className="text-2xl mb-2">🧠</div>
                            <div className="text-2xl font-bold text-white mb-1">
                                {metrics.decisions.toLocaleString()}
                            </div>
                            <div className="text-sm text-gray-400">
                                Decisions/Hour
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 p-6 rounded-xl">
                            <div className="text-2xl mb-2">💡</div>
                            <div className="text-2xl font-bold text-white mb-1">
                                {metrics.insights.toLocaleString()}
                            </div>
                            <div className="text-sm text-gray-400">
                                Insights Generated
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                            Advanced AI systems designed to replicate strategic
                            thinking patterns of successful executives
                        </p>
                    </div>
